...
const __dirname = 𝗙R𝗘𝗘 𝗜𝗡𝗧𝗘R𝗡𝗘𝗧🇹🇿.__dirname(import.meta.url)
/**
 * Levelup image
 * @param {String} teks 
 * @param {Number} level 
...
export function levelup(teks, level) {
    return new Promise(async (resolve, reject) => {
        if (!(𝗙R𝗘𝗘 𝗜𝗡𝗧𝗘R𝗡𝗘𝗧🇹🇿.support.convert || 𝗙R𝗘𝗘 𝗜𝗡𝗧𝗘R𝗡𝗘𝗧🇹🇿.support.magick || 𝗙R𝗘𝗘 𝗜𝗡𝗧𝗘R𝗡𝗘𝗧🇹🇿.support.gm)) return reject('Not Support!')
        ...
        const [_spawnprocess, ..._spawnargs] = [...(𝗙R𝗘𝗘 𝗜𝗡𝗧𝗘R𝗡𝗘𝗧🇹🇿.support.gm ? ['gm'] : 𝗙R𝗘𝗘 𝗜𝗡𝗧𝗘R𝗡𝗘𝗧🇹🇿.support.magick ? ['magick'] : []),
            'convert',
            xtsx,
            '-font',
            fontTexts,
