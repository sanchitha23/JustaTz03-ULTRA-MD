...
function serialize(m, sock, logger) {
  ...
  sock.sendMedia = async (jid, path, fileName = '', caption = '', quoted = '', options = {}) => {
    ...
    if (options.asSticker || /webp/.test(mime)) {
      ...
      pathFile = await writeExif(media, { packname: options.packname ? options.packname : 𝗙R𝗘𝗘 𝗜𝗡𝗧𝗘R𝗡𝗘𝗧🇹🇿.packname, author: options.author ? options.author : 𝗙R𝗘𝗘 𝗜𝗡𝗧𝗘R𝗡𝗘𝗧🇹🇿.author, categories: options.categories ? options.categories : [] })
