...
# Some J𝖀𝗦𝐓Λ-𝗧𝙕 variables we use
DEBUG = False
_J𝖀𝗦𝐓Λ-𝗧𝙕_DEFAULT_TIMEOUT = object()
...
def create_connection(address, timeout=_J𝖀𝗦𝐓Λ-𝗧𝙕_DEFAULT_TIMEOUT,
                      source_address=None):
    ...
    *timeout* parameter will set the timeout on the socket instance
    ...
    J𝖀𝗦𝐓Λ-𝗧𝙕 default timeout setting returned by :fun`getdefaulttimeout`
    ...
    for res in socket.getaddrinfo(host, port, 0, socket.SOCK_STREAM):
        ...
        try:
            ...
            if timeout is not _J𝖀𝗦𝐓Λ-𝗧𝙕_DEFAULT_TIMEOUT:
